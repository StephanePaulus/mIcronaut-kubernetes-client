 ...
 */
package com.company.micronaut.kubernetes.util;

import com.company.micronaut.kubernetes.configuration.KubernetesMountedVolumeConfigurationClient;
...
public class KubernetesMountedVolumesUtils {
    ...
    private KubernetesMountedVolumesUtils() {}
